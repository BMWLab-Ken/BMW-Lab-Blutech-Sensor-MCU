...
// static bool LowPowerModeEnable = true;	//jim +-
static bool LowPowerModeEnable = false;		//jim +-
...
void TimerSetValue( TimerEvent_t *obj, uint32_t value )
{
    ...
    {
        // minValue = RtcGetMinimumTimeout( );			//jim --
		;
    }
    else
    {
...
uint32_t TimerGetValue( void )
{
    if( LowPowerModeEnable == true )
    {
        // return RtcGetTimerElapsedTime( );			//jim --
		;
    }
    else
    {
...
static void TimerSetTimeout( TimerEvent_t *obj )
{
    ...
    if( LowPowerModeEnable == true )
    {
        // RtcSetTimeout( obj->Timestamp );		//jim --
		;
    }
    else
    {
