...
// I2c_t I2c;	//jim mark, 20150815	
Uart_t Uart1;	//jim ++, 20150815
/*!
...
void BoardInitMcu( void )
{
    if( McuInitialized == false )
    {
        ...
        // I2cInit( &I2c, I2C_SCL, I2C_SDA );		//jim mark, 20150815	
...
#endif
        // BoardInitPeriph( );		//jim mark, 20150815	
        ...
        // if( TimerGetLowPowerEnable( ) == true )		//jim --, 20150816
        // {
            // RtcInit( );
        // }
        // else
...
{
    // Gpio_t ioPin;
#if 0	//jim mark, 20150816
    //I2cDeInit( &I2c );        //jim --, 20150815
