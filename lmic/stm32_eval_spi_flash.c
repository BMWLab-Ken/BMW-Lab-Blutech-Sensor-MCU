...
void sFLASH_LowLevel_Init(void);		//jim ++, 20150816
void sFLASH_LowLevel_DeInit(void);		//jim ++, 20150816
...
void sFLASH_Init(void)
{
  ...
  SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_32;//SPI_BaudRatePrescaler_4;	jim
...
//jim ++, 20150816, 把下面這個函示搬過來，就不用拉一堆程式進來
