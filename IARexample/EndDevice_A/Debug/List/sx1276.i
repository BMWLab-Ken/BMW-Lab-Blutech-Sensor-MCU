...
const RadioRegisters_t RadioRegsInit[] = { { MODEM_FSK , 0x0C , 0x23 }, { MODEM_FSK , 0x0D , 0x1E }, { MODEM_FSK , 0x0E , 0xD2 }, { MODEM_FSK , 0x1F , 0xAA }, { MODEM_FSK , 0x24 , 0x07 }, { MODEM_FSK , 0x27 , 0x12 }, { MODEM_FSK , 0x28 , 0xC1 }, { MODEM_FSK , 0x29 , 0x94 }, { MODEM_FSK , 0x2A , 0xC1 }, { MODEM_FSK , 0x30 , 0xD8 }, { MODEM_FSK , 0x35 , 0x8F }, { MODEM_FSK , 0x3B , 0x02 }, { MODEM_FSK , 0x40 , 0x00 }, { MODEM_FSK , 0x41 , 0x30 }, { MODEM_LORA, 0x23, 0x40 },};
...
void SX1276SetChannel( uint32_t freq )
{
    ...
    SX1276Write( 0x06, ( uint8_t )( ( freq >> 16 ) & 0xFF ) );
    SX1276Write( 0x07, ( uint8_t )( ( freq >> 8 ) & 0xFF ) );
    SX1276Write( 0x08, ( uint8_t )( freq & 0xFF ) );
}
...
uint32_t SX1276Random( void )
{
    ...
    for( i = 0; i < 32; i++ )
    {
        ...
        rnd |= ( ( uint32_t )SX1276Read( 0x2C ) & 0x01 ) << i;
    }
...
static void RxChainCalibration( void )
{
    ...
    regPaConfigInitVal = SX1276Read( 0x09 );
    initialFreq = ( double )( ( ( uint32_t )SX1276Read( 0x06 ) << 16 ) |
                              ( ( uint32_t )SX1276Read( 0x07 ) << 8 ) |
                              ( ( uint32_t )SX1276Read( 0x08 ) ) ) * ( double )61.03515625;

    
    SX1276Write( 0x09, 0x00 );

    
    SX1276Write( 0x3B, ( SX1276Read( 0x3B ) & 0xBF ) | 0x40 );
    while( ( SX1276Read( 0x3B ) & 0x20 ) == 0x20 )
    {
    }
    ...
    SX1276Write( 0x09, regPaConfigInitVal );
    ...
    case MODEM_FSK:
        {
            ...
            datarate = ( uint16_t )( ( double )32000000 / ( double )datarate );
            SX1276Write( 0x02, ( uint8_t )( datarate >> 8 ) );
            SX1276Write( 0x03, ( uint8_t )( datarate & 0xFF ) );

            SX1276Write( 0x12, GetFskBandwidthRegValue( bandwidth ) );
            SX1276Write( 0x13, GetFskBandwidthRegValue( bandwidthAfc ) );

            SX1276Write( 0x25, ( uint8_t )( ( preambleLen >> 8 ) & 0xFF ) );
            SX1276Write( 0x26, ( uint8_t )( preambleLen & 0xFF ) );
            
            if( fixLen == 1 )
            {
                SX1276Write( 0x32, payloadLen );
            }
    ...
    case MODEM_LORA:
        {
            ...
            SX1276Write( 0x1F, ( uint8_t )( symbTimeout & 0xFF ) );
            
            SX1276Write( 0x20, ( uint8_t )( ( preambleLen >> 8 ) & 0xFF ) );
            SX1276Write( 0x21, ( uint8_t )( preambleLen & 0xFF ) );

            if( fixLen == 1 )
            {
                SX1276Write( 0x22, payloadLen );
            }

            if( SX1276.Settings.LoRa.FreqHopOn == 1 )
            {
                SX1276Write( 0x44, ( SX1276Read( 0x44 ) & 0x7F ) | 0x80 );
                SX1276Write( 0x24, SX1276.Settings.LoRa.HopPeriod );
            }

            if( ( bandwidth == 9 ) && ( 525000000 ) )
            {
                        ...
                        uint8_t hopPeriod, _Bool iqInverted, uint32_t timeout )
{
    ...
    paConfig = SX1276Read( 0x09 );
    paDac = SX1276Read( 0x4D );

    paConfig = ( paConfig & 0x7F ) | SX1276GetPaSelect( SX1276.Settings.Channel );
    paConfig = ( paConfig & 0x8F ) | 0x70;

    if( ( paConfig & 0x80 ) == 0x80 )
    {
        if( power > 17 )
        {
            paDac = ( paDac & 0xF8 ) | 0x07;
        }
        else
        {
            paDac = ( paDac & 0xF8 ) | 0x04;
        }
        if( ( paDac & 0x07 ) == 0x07 )
        {
            if( power < 5 )
            ...
            paConfig = ( paConfig & 0xF0 ) | ( uint8_t )( ( uint16_t )( power - 5 ) & 0x0F );
        }
        else
        {
            if( power < 2 )
            ...
            paConfig = ( paConfig & 0xF0 ) | ( uint8_t )( ( uint16_t )( power - 2 ) & 0x0F );
        }
    }
    else
    {
        ...
        paConfig = ( paConfig & 0xF0 ) | ( uint8_t )( ( uint16_t )( power + 1 ) & 0x0F );
    }
    SX1276Write( 0x09, paConfig );
    SX1276Write( 0x4D, paDac );
    ...
    case MODEM_FSK:
        {
            ...
            fdev = ( uint16_t )( ( double )fdev / ( double )61.03515625 );
            SX1276Write( 0x04, ( uint8_t )( fdev >> 8 ) );
            SX1276Write( 0x05, ( uint8_t )( fdev & 0xFF ) );

            datarate = ( uint16_t )( ( double )32000000 / ( double )datarate );
            SX1276Write( 0x02, ( uint8_t )( datarate >> 8 ) );
            SX1276Write( 0x03, ( uint8_t )( datarate & 0xFF ) );

            SX1276Write( 0x25, ( preambleLen >> 8 ) & 0x00FF );
            SX1276Write( 0x26, preambleLen & 0xFF );
    ...
    case MODEM_LORA:
        {
            ...
            SX1276Write( 0x20, ( preambleLen >> 8 ) & 0x00FF );
            SX1276Write( 0x21, preambleLen & 0xFF );
    ...
    case MODEM_FSK:
        {
            airTime = round( ( 8 * ( SX1276.Settings.Fsk.PreambleLen +
                                     ( ( SX1276Read( 0x27 ) & ~0xF8 ) + 1 ) +
                                     ( ( SX1276.Settings.Fsk.FixLen == 0x01 ) ? 0.0 : 1.0 ) +
                                     ( ( ( SX1276Read( 0x30 ) & ~0xF9 ) != 0x00 ) ? 1.0 : 0 ) +
                                     pktLen +
...
void SX1276Send( uint8_t *buffer, uint8_t size )
{
    ...
    case MODEM_FSK:
        {
            ...
            if( SX1276.Settings.Fsk.FixLen == 0 )
            {
                SX1276WriteFifo( ( uint8_t* )&size, 1 );
            }
            else
            {
                SX1276Write( 0x32, size );
            }            
    ...
    case MODEM_LORA:
        {
            if( SX1276.Settings.LoRa.IqInverted == 1 )
            {
                SX1276Write( 0x33, ( ( SX1276Read( 0x33 ) & 0xFE & 0xBF ) | 0x00 | 0x00 ) );
                SX1276Write( 0x3B, 0x19 );
            }
            else
            {
                SX1276Write( 0x33, ( ( SX1276Read( 0x33 ) & 0xFE & 0xBF ) | 0x00 | 0x01 ) );
                SX1276Write( 0x3B, 0x1D );
            }      
...
void SX1276SetStby( void )
{
    ...
    SX1276SetOpMode( 0x01 );
    SX1276.Settings.State = RF_IDLE;
}

void SX1276SetRx( uint32_t timeout )
{
    _Bool rxContinuous = 0;
    ...
    case MODEM_FSK:
        {
            ...
            SX1276Write( 0x40, ( SX1276Read( 0x40 ) & 0x3F &
                                                                            0xF3 ) |
                                                                            0x00 |
                                                                            0x0C );
            
            SX1276Write( 0x41, ( SX1276Read( 0x41 ) & 0x3F &
                                                                            0xFE ) | 
                                                                            0xC0 |
                                                                            0x01 );
            
            SX1276.Settings.FskPacketHandler.FifoThresh = SX1276Read( 0x35 ) & 0x3F;
    ...
    case MODEM_LORA:
        {
            if( SX1276.Settings.LoRa.IqInverted == 1 )
            {
                SX1276Write( 0x33, ( ( SX1276Read( 0x33 ) & 0xFE & 0xBF ) | 0x40 | 0x01 ) );
                SX1276Write( 0x3B, 0x19 );
            }
            else
            {
            ...
            if( SX1276.Settings.LoRa.FreqHopOn == 1 )
            {
                ...
                SX1276Write( 0x40, ( SX1276Read( 0x40 ) & 0x3F & 0xF3  ) | 0x00 | 0x00 );
            }
            else
            {
                SX1276Write( 0x11, 
                ...
                SX1276Write( 0x40, ( SX1276Read( 0x40 ) & 0x3F ) | 0x00 );
    ...
    case MODEM_LORA:
        {
            if( SX1276.Settings.LoRa.FreqHopOn == 1 )
            {
                ...
                SX1276Write( 0x40, ( SX1276Read( 0x40 ) & 0x3F & 0xF3 ) | 0x40 | 0x00 );
            }
            else
            {
                SX1276Write( 0x11, 0x80 |
                ...
                SX1276Write( 0x40, ( SX1276Read( 0x40 ) & 0x3F ) | 0x40 );
            }
        }
        break;
    }
...
int16_t SX1276ReadRssi( RadioModems_t modem )
{
    ...
    {
    case MODEM_FSK:
        rssi = -( SX1276Read( 0x11 ) >> 1 );
        break;
    case MODEM_LORA:
        if( SX1276.Settings.Channel > 525000000 )
        {
            rssi = -157 + SX1276Read( 0x1B );
        }
        else
        {
            rssi = -164 + SX1276Read( 0x1B );
        }
        break;
    default:
        rssi = -1;
...
void SX1276SetOpMode( uint8_t opMode )
{
    ...
    if( opMode != opModePrev )
    {
        ...
        SX1276Write( 0x01, ( SX1276Read( 0x01 ) & 0xF8 ) | opMode );
    }
}
...
void SX1276SetModem( RadioModems_t modem )
{
    ...
    case MODEM_FSK:
        SX1276SetOpMode( 0x00 );
        SX1276Write( 0x01, ( SX1276Read( 0x01 ) & 0x7F ) | 0x00 );
    
        SX1276Write( 0x40, 0x00 );
        SX1276Write( 0x41, 0x30 ); 
        break;
    case MODEM_LORA:
        SX1276SetOpMode( 0x00 );
        SX1276Write( 0x01, ( SX1276Read( 0x01 ) & 0x7F ) | 0x80 );
...
void SX1276OnTimeoutIrq( void )
{
    ...
    case RF_RX_RUNNING:
        if( SX1276.Settings.Modem == MODEM_FSK )
        {
            ...
            SX1276Write( 0x3E, 0x08 | 
                                        0x02 |
                                        0x01 );
            SX1276Write( 0x3F, 0x10 );

            if( SX1276.Settings.Fsk.RxContinuous == 1 )
            {
                
                SX1276Write( 0x0D, SX1276Read( 0x0D ) | 0x40 );
            }
            else
            {
                SX1276.Settings.State = RF_IDLE;
    ...
    case RF_TX_RUNNING:
        SX1276.Settings.State = RF_IDLE;
        if( ( RadioEvents != 0 ) && ( RadioEvents->TxTimeout != 0 ) )
        {
...
void SX1276OnDio0Irq( void )
{
    ...
    {                
        case RF_RX_RUNNING:
            ...
            {
            case MODEM_FSK:
                if( SX1276.Settings.Fsk.CrcOn == 1 )
                {
                    irqFlags = SX1276Read( 0x3F );
                    if( ( irqFlags & 0x02 ) != 0x02 )
                    {
                        ...
                        if( SX1276.Settings.Fsk.RxContinuous == 0 )
                        {
                            SX1276.Settings.State = RF_IDLE;
                            TimerStart( &RxTimeoutSyncWord );
                        }
                ...
                if( ( SX1276.Settings.FskPacketHandler.Size == 0 ) && ( SX1276.Settings.FskPacketHandler.NbBytes == 0 ) )
                {
                    ...
                    {
                        SX1276.Settings.FskPacketHandler.Size = SX1276Read( 0x32 );
                    }
            ...
            case MODEM_LORA:
                {
                    ...
                    irqFlags = SX1276Read( 0x12 );
                    if( ( irqFlags & 0x20 ) == 0x20 )
                    {
                        
                        SX1276Write( 0x12, 0x20 );

                        if( SX1276.Settings.LoRa.RxContinuous == 0 )
                        {
                            SX1276.Settings.State = RF_IDLE;
                        }
                        TimerStop( &RxTimeoutTimer );
                    ...
                    SX1276.Settings.LoRaPacketHandler.SnrValue = SX1276Read( 0x19 );
                    ...
                    int16_t rssi = SX1276Read( 0x1A );
                    if( snr < 0 )
                    {
                        if( SX1276.Settings.Channel > 525000000 )
                        {
                            SX1276.Settings.LoRaPacketHandler.RssiValue = -157 + rssi + ( rssi >> 4 ) +
                                                                          snr;
                        }
                        else
                        {
                            SX1276.Settings.LoRaPacketHandler.RssiValue = -164 + rssi + ( rssi >> 4 ) +
                                                                          snr;
                        }
                    }
                    else
                    ...
                    SX1276.Settings.LoRaPacketHandler.Size = SX1276Read( 0x13 );
...
void SX1276OnDio2Irq( void )
{
    ...
    {                
        case RF_RX_RUNNING:
            ...
            {
            case MODEM_FSK:
                if( ( SX1276.Settings.FskPacketHandler.PreambleDetected == 1 ) && ( SX1276.Settings.FskPacketHandler.SyncWordDetected == 0 ) )
                {
                    TimerStop( &RxTimeoutSyncWord );
                    
                    SX1276.Settings.FskPacketHandler.SyncWordDetected = 1;
                
                    SX1276.Settings.FskPacketHandler.RssiValue = -( SX1276Read( 0x11 ) >> 1 );

                    SX1276.Settings.FskPacketHandler.AfcValue = ( int32_t )( double )( ( ( uint16_t )SX1276Read( 0x1B ) << 8 ) |
                                                                           ( uint16_t )SX1276Read( 0x1C ) ) *
                                                                           ( double )61.03515625;
                    SX1276.Settings.FskPacketHandler.RxGain = ( SX1276Read( 0x0C ) >> 5 ) & 0x07;
                }
                break;
            case MODEM_LORA:
                if( SX1276.Settings.LoRa.FreqHopOn == 1 )
                {
                    ...
                    if( ( RadioEvents != 0 ) && ( RadioEvents->FhssChangeChannel != 0 ) )
                    {
                        RadioEvents->FhssChangeChannel( ( SX1276Read( 0x1C ) & 0x3F ) );
                    }
                }
                break;
            default:
...
void SX1276OnDio3Irq( void )
{
    ...
    case MODEM_FSK:
        break;
    case MODEM_LORA:
        if( ( SX1276Read( 0x12 ) & 0x01 ) == 0x01 )
        {
            
            SX1276Write( 0x12, 0x01 | 0x04 );
            if( ( RadioEvents != 0 ) && ( RadioEvents->CadDone != 0 ) )
            {
                RadioEvents->CadDone( 1 );
            }
        }
        else
        {        
...
void SX1276OnDio4Irq( void )
{
    ...
    case MODEM_FSK:
        {
            if( SX1276.Settings.FskPacketHandler.PreambleDetected == 0 )
            {
                SX1276.Settings.FskPacketHandler.PreambleDetected = 1;
            }    
        }
        break;
    case MODEM_LORA:
...
void hal_pin_rst (u1_t val) {
    ...
    if(val == 0 || val == 1) { 
        ...
        hw_set_pin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), 0, val);
    } else { 
		GPIO_InitStructure.GPIO_Pin = 0;
		GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
...
void writeReg (u1_t addr, u1_t data ) {
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0004));
    sFLASH_SendByte(addr | 0x80);	
    sFLASH_SendByte(data);	
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0004));
}


uint8_t readReg (u1_t addr) {
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0004)); 
    sFLASH_SendByte(addr & 0x7F);	
    u1_t val = sFLASH_SendByte(0x00);	
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0004));
    return val;
}
