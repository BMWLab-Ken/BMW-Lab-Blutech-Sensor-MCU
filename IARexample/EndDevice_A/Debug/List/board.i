...
void BoardGetUniqueId( uint8_t *id )
{
    id[0] = ( ( *( uint32_t* )( 0x1FF80050 ) )+ ( *( uint32_t* )( 0x1FF80064 ) ) ) >> 24;
    id[1] = ( ( *( uint32_t* )( 0x1FF80050 ) )+ ( *( uint32_t* )( 0x1FF80064 ) ) ) >> 16;
    id[2] = ( ( *( uint32_t* )( 0x1FF80050 ) )+ ( *( uint32_t* )( 0x1FF80064 ) ) ) >> 8;
    id[3] = ( ( *( uint32_t* )( 0x1FF80050 ) )+ ( *( uint32_t* )( 0x1FF80064 ) ) );
    id[4] = ( ( *( uint32_t* )( 0x1FF80054 ) ) ) >> 24;
    id[5] = ( ( *( uint32_t* )( 0x1FF80054 ) ) ) >> 16;
    id[6] = ( ( *( uint32_t* )( 0x1FF80054 ) ) ) >> 8;
    id[7] = ( ( *( uint32_t* )( 0x1FF80054 ) ) );
}
...
uint8_t BoardMeasureBatterieLevel( void ) 
{
    ...
    for( i = 0; i <= 6; i++ ) 
    {
        ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR = ( ( tmpreg & 0xFFFFFF1F ) | ( i << 5 ) ); 
        DelayMs( 1 );
        if( PWR_GetFlagStatus( ((uint32_t)0x00000004) ) == 1 )
        {
            result |= 0x01 << i; 
        }
    }
