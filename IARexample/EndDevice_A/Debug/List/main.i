...
void debug_val (const uint8_t* label, uint32_t val);
...
static uint8_t AppData[8];
static uint8_t BLRM_RevData[8];
static uint8_t PC_Commend[8];
int8_t rsp_len=0; 
int8_t len=0; 
int8_t data_len=0; 
...
static _Bool ComDone = 0;
static _Bool RxDone = 0;
static _Bool TxDone = 0;
...
static _Bool SendFrame( void )
{

   
     LoRaMacSendConfirmedFrame( AppPort, AppData, AppDataSize, 1);	
...
void USART1_IRQHandler() {	
  if(USART_GetITStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0525)) != RESET) {
                ...
                BLRM_RevData[len]=(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR);
                len++;
                RxDone = 1;
	}
}
...
void USART3_IRQHandler() {	
  if(USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0525)) != RESET) {
                ...
                PC_Commend[len]=(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR);
                len++;
                ComDone = 1;
	}
}
