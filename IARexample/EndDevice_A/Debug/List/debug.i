...
void debug_init () {
	...
	USART_InitTypeDef USART_InitStructure;
        ...
        RCC_APB2PeriphClockCmd(((uint32_t)0x00000004) | ((uint32_t)0x00000008) | ((uint32_t)0x00000001) , ENABLE);
...
void debug_char (uint8_t c) {
    while( !(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->SR & ((uint16_t)0x0080)) );    
    ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR = c;
}
void debug_char_UART1 (uint8_t c) {
    while( !(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR & ((uint16_t)0x0080)) );    
    ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR = c;
}
void debug_hex (uint8_t b) {
