...
static _Bool LowPowerModeEnable = 0;		
...
static TimerEvent_t *TimerListHead = 0;
...
static _Bool TimerExists( TimerEvent_t *obj );
...
void TimerIrqHandler( void )
{
    ...
    while( ( TimerListHead != 0 ) && ( TimerListHead->Timestamp == 0 ) )
    {         
        if( TimerListHead->Next != 0 )
        {
    ...
    while( ( elapsedTimer != 0 ) && ( elapsedTimer->Timestamp == 0 ) )
    {
        if( elapsedTimer->Callback != 0 )
        {
...
void TimerLowPowerHandler( void )
{
    if( ( TimerListHead != 0 ) && ( TimerListHead->IsRunning == 1 ) ) 
    {    
