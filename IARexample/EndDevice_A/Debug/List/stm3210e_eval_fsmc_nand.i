...
void NAND_Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000020) | ((uint32_t)0x00000040) | 
                         ((uint32_t)0x00000080) | ((uint32_t)0x00000100), ENABLE);
  
 
 
  GPIO_InitStructure.GPIO_Pin =  ((uint16_t)0x0800) | ((uint16_t)0x1000) | ((uint16_t)0x4000) | ((uint16_t)0x8000) |  
...
void NAND_ReadID(NAND_IDTypeDef* NAND_ID)
{
  ...
  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = 0x90;
  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = 0x00;

    
   data = *(volatile uint32_t *)(((uint32_t)0x70000000) | ((uint32_t)0x00000000));
...
uint32_t NAND_WriteSmallPage(uint8_t *pBuffer, NAND_ADDRESS Address, uint32_t NumPageToWrite)
{
  uint32_t index = 0x00, numpagewritten = 0x00, addressstatus = ((uint32_t)0x00000100);
  uint32_t status = ((uint32_t)0x00000040), size = 0x00;

  while((NumPageToWrite != 0x00) && (addressstatus == ((uint32_t)0x00000100)) && (status == ((uint32_t)0x00000040)))
  {
     
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0x00);
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0x80);

    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = 0x00;
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)(((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF);
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)((((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF00) >> 8);
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)((((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF0000) >> 16);

     
    size = ((uint16_t)0x0200) + (((uint16_t)0x0200) * numpagewritten);

     
    for(; index < size; index++)
    {
      *(volatile uint8_t *)(((uint32_t)0x70000000) | ((uint32_t)0x00000000)) = pBuffer[index];
    }
    
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0x10);
...
uint32_t NAND_ReadSmallPage(uint8_t *pBuffer, NAND_ADDRESS Address, uint32_t NumPageToRead)
{
  uint32_t index = 0x00, numpageread = 0x00, addressstatus = ((uint32_t)0x00000100);
  uint32_t status = ((uint32_t)0x00000040), size = 0x00;

  while((NumPageToRead != 0x0) && (addressstatus == ((uint32_t)0x00000100)))
  {
    ...
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)((((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF0000) >> 16);
    ...
    size = ((uint16_t)0x0200) + (((uint16_t)0x0200) * numpageread);
    
         
    for(; index < size; index++)
    {
      pBuffer[index]= *(volatile uint8_t *)(((uint32_t)0x70000000) | ((uint32_t)0x00000000));
    }
...
uint32_t NAND_WriteSpareArea(uint8_t *pBuffer, NAND_ADDRESS Address, uint32_t NumSpareAreaTowrite)
{
  uint32_t index = 0x00, numsparesreawritten = 0x00, addressstatus = ((uint32_t)0x00000100);
  uint32_t status = ((uint32_t)0x00000040), size = 0x00; 

  while((NumSpareAreaTowrite != 0x00) && (addressstatus == ((uint32_t)0x00000100)) && (status == ((uint32_t)0x00000040)))
  {
     
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0x50);
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0x80);
    ...
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)((((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF0000) >> 16);
    ...
    size = ((uint16_t)0x0010) + (((uint16_t)0x0010) * numsparesreawritten);
...
uint32_t NAND_ReadSpareArea(uint8_t *pBuffer, NAND_ADDRESS Address, uint32_t NumSpareAreaToRead)
{
  uint32_t numsparearearead = 0x00, index = 0x00, addressstatus = ((uint32_t)0x00000100);
  uint32_t status = ((uint32_t)0x00000040), size = 0x00;

  while((NumSpareAreaToRead != 0x0) && (addressstatus == ((uint32_t)0x00000100)))
  {     
    ...
    *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)((((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF0000) >> 16);
    ...
    size = ((uint16_t)0x0010) +  (((uint16_t)0x0010) * numsparearearead);
...
uint32_t NAND_EraseBlock(NAND_ADDRESS Address)
{
  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0x60);

  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)(((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF);
  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)((((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF00) >> 8);
  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<17)) = (uint8_t)((((Address . Page + (Address . Block + (Address . Zone * ((uint16_t)0x0400))) * ((uint16_t)0x0020)))& 0xFF0000) >> 16);

  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0xD0); 
...
uint32_t NAND_Reset(void)
{
  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0xFF);
...
uint32_t NAND_GetStatus(void)
{
  uint32_t timeout = 0x1000000, status = ((uint32_t)0x00000040);

  status = NAND_ReadStatus();

   
  while ((status != ((uint32_t)0x00000040)) &&( timeout != 0x00))
  {
     status = NAND_ReadStatus();
     timeout --;
  }
...
uint32_t NAND_ReadStatus(void)
{
  uint32_t data = 0x00, status = ((uint32_t)0x00000000);

   
  *(volatile uint8_t *)(((uint32_t)0x70000000) | (uint32_t)(1<<16)) = ((uint8_t)0x70);
  data = *(volatile uint8_t *)(((uint32_t)0x70000000));

  if((data & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001))
  {
    status = ((uint32_t)0x00000001);
  } 
  else if((data & ((uint32_t)0x00000040)) == ((uint32_t)0x00000040))
  {
    status = ((uint32_t)0x00000040);
  }
  else
  {
    status = ((uint32_t)0x00000000); 
  }
...
uint32_t NAND_AddressIncrement(NAND_ADDRESS* Address)
{
  ...
  if(Address->Page == ((uint16_t)0x0020))
  {
    Address->Page = 0;
    Address->Block++;
    
    if(Address->Block == ((uint16_t)0x0400))
    {
      Address->Block = 0;
      Address->Zone++;

      if(Address->Zone == ((uint16_t)0x0004))
      {
