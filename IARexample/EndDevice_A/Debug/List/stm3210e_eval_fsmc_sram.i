...
void SRAM_Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000020) | ((uint32_t)0x00000100) | ((uint32_t)0x00000040) |
...
void SRAM_WriteBuffer(uint16_t* pBuffer, uint32_t WriteAddr, uint32_t NumHalfwordToWrite)
{
  for(; NumHalfwordToWrite != 0; NumHalfwordToWrite--)  
  {
    ...
    *(uint16_t *) (((uint32_t)0x68000000) + WriteAddr) = *pBuffer++;
...
void SRAM_ReadBuffer(uint16_t* pBuffer, uint32_t ReadAddr, uint32_t NumHalfwordToRead)
{
  for(; NumHalfwordToRead != 0; NumHalfwordToRead--)  
  {
    ...
    *pBuffer++ = *(volatile uint16_t*) (((uint32_t)0x68000000) + ReadAddr);
