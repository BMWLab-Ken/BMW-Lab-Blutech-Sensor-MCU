...
static const u1_t outputpins[] = { 1, 6, 2, 1  };
...
void configure_the_NVIC( u1_t portidx, u1_t pin, u1_t irqcfg ){
    
    u4_t tmp1 = (pin & 0x3) << 2;
    u4_t tmp2 = ((u4_t)0x0F) << tmp1;
    ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[pin >> 2] = (((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[pin >> 2] & ~tmp2) | (((u4_t)portidx) << tmp1);	
    
    u4_t mask = (u4_t)(1 << pin);
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR &= ~mask; 
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTSR &= ~mask; 
    switch(irqcfg & 0x38) {
      case 0x28:   ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR |= mask; break; 
      case 0x20:  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTSR |= mask; break; 
      case 0x30:   ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR |= mask; ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTSR |= mask; break; 
    }
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR |= mask;   
	
    u1_t channel = (pin < 5) ? (EXTI0_IRQn+pin) : ((pin<10) ? EXTI9_5_IRQn : EXTI15_10_IRQn);
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->IP[channel] = 0x70; 
...
static void hal_io_init () {
    ...
    for(u1_t i=0; i<sizeof(outputpins); i+=2) {
		...
		GPIO_Init(((GPIO_TypeDef*) (((((uint32_t)0x40000000) + 0x10000) + 0x0800) + (outputpins[i])*(((((uint32_t)0x40000000) + 0x10000) + 0x0C00)-((((uint32_t)0x40000000) + 0x10000) + 0x0800)))), &GPIO_InitStructure);		
		
        hw_set_pin(((GPIO_TypeDef*) (((((uint32_t)0x40000000) + 0x10000) + 0x0800) + (outputpins[i])*(((((uint32_t)0x40000000) + 0x10000) + 0x0C00)-((((uint32_t)0x40000000) + 0x10000) + 0x0800)))), outputpins[i+1], 0);
    }	
	...
	GPIO_EXTILineConfig(((uint8_t)0x00), ((uint8_t)0x02));
...
void hal_pin_rxtx (u1_t val) {
    if(!(val == 1 || val == 0)) hal_failed();
    hw_set_pin(((GPIO_TypeDef*) (((((uint32_t)0x40000000) + 0x10000) + 0x0800) + (2)*(((((uint32_t)0x40000000) + 0x10000) + 0x0C00)-((((uint32_t)0x40000000) + 0x10000) + 0x0800)))), 1, val);
}



void hal_pin_nss (u1_t val) {
	hw_set_pin(((GPIO_TypeDef*) (((((uint32_t)0x40000000) + 0x10000) + 0x0800) + (1)*(((((uint32_t)0x40000000) + 0x10000) + 0x0C00)-((((uint32_t)0x40000000) + 0x10000) + 0x0800)))), 6, val);
}
...
void EXTI_IRQHandler () {
    ...
    if((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR & (1<<0)) != 0) { 
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR = (1<<0); 
        
        radio_irq_handler(0);
    }
		
    
    if((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR & (1<<1)) != 0) { 
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR = (1<<1); 
        
        radio_irq_handler(1);
    }
    
    if((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR & (1<<2)) != 0) { 
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR = (1<<2); 
...
u1_t hal_spi (u1_t out) {
    ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->DR = out;
    while( (((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->SR & ((uint8_t)0x01) ) == 0);
...
u4_t hal_ticks () {
    hal_disableIRQs();
    u4_t t = HAL.ticks;
    u2_t cnt = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT;       
    if( (((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->SR & ((uint16_t)0x0001)) ) {
        
        
        
        cnt = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT;
        t++;
    }
    hal_enableIRQs();
    return (t<<16)|cnt;
...
u1_t hal_checkTimer (u4_t time) {
    u2_t dt;
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->SR &= ~((uint16_t)0x0004); 
    if((dt = deltaticks(time)) < 5) { 
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->DIER &= ~((uint16_t)0x0004); 
        return 1;
    } else { 
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR2 = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT + dt;   
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->DIER |= ((uint16_t)0x0004);  
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCER |= ((uint16_t)0x0010);   
        return 0;
    }
}
...
void TIM3_IRQHandler () {
    ...
    if((((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->SR & ((uint16_t)0x0004)) && (((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->DIER & ((uint16_t)0x0004))) { 
