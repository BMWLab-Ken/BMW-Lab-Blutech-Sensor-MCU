...
typedef enum {
    SPI_1 = ( uint32_t )((((uint32_t)0x40000000) + 0x10000) + 0x3000),
    SPI_2 = ( uint32_t )(((uint32_t)0x40000000) + 0x3800),
    SPI_3 = ( uint32_t )(((uint32_t)0x40000000) + 0x3C00),
} SPIName;
...
void SpiFormat( Spi_t *obj, int8_t bits, int8_t cpol, int8_t cpha, int8_t slave )
{
    ...
    SPI_InitStructure.SPI_Mode = ( slave == 0x01 ) ? ((uint16_t)0x0000) : ((uint16_t)0x0104);
    SPI_InitStructure.SPI_CPOL = ( cpol == 0x01 ) ? ((uint16_t)0x0002) : ((uint16_t)0x0000);
    SPI_InitStructure.SPI_CPHA = ( cpha == 0x01 ) ? ((uint16_t)0x0001) : ((uint16_t)0x0000);
    SPI_InitStructure.SPI_DataSize = ( bits == 8 ) ? ((uint16_t)0x0000) : ((uint16_t)0x0800);
...
uint16_t SpiInOut( Spi_t *obj, uint16_t outData )
{
    ...
    while( SPI_I2S_GetFlagStatus( obj->Spi, ((uint16_t)0x0002) ) == RESET );
    SPI_I2S_SendData( obj->Spi, outData );
    while( SPI_I2S_GetFlagStatus( obj->Spi, ((uint16_t)0x0001) ) == RESET );
